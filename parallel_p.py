...
# Date-9 Dec 2017
# A TurtleBot script that moves the Turtlebot parallel to wall using P controller. Press CTRL + C to stop.  To run:
# On TurtleBot:
...
#refrence ditance to calculate error
ref_dist=25 #in cm
kp=0.1
#allowed_error=1 #in cm
...
def callback(data):
    ...
    #deciding angular velocity depending on the deviation from the refrence distance
