...
# USAGE: python2 centroid join.py --image dataset/test4_color.jpeg
 ...
 for j in range (len(roi_centroids)):
     ...
     if (j!=i):
         ...
         if (diff < 5):
             ...
             cv2.imwrite('messigray.jpg',img_croped)
             # draw a red 'nghien' rectangle
             #cv2.drawContours(image, [box], 0, (0, 0, 255))
